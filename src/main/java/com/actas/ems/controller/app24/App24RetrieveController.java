...
import com.actas.ems.Service.elvlrt.App24.App24ElvlrtService;
...
public class App24RetrieveController {

    private final App24ElvlrtService service;
    ...
    public Object App1601TabForm(@RequestParam("frdate") String frdate,
        ...
        try{
            ...
            app16DtoList = service.GetApp24List001(popParmDto);
    ...
    public Object App24001Tab02Form(@RequestParam("frdate") String frdate,
        ...
        popParmDto.setActcd(actcd);
        try{
            app16DtoList = service.GetApp24List002(popParmDto);
