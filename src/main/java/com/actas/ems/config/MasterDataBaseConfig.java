...
@Configuration
@MapperScan(value="com.actas.ems.mapper.master", sqlSessionFactoryRef="masterSqlSessionFactory")
...
public class MasterDataBaseConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("masterDataSource") DataSource masterDataSource, ApplicationContext applicationContext) throws Exception{
        ...
        sqlSessionFactoryBean.setMapperLocations(applicationContext.getResources("classpath:com/actas/ems/mapper/master/*.xml"));
