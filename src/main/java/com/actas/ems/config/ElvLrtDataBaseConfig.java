...
@Configuration
@MapperScan(value="com.actas.ems.mapper.elvlrt", sqlSessionFactoryRef="elvlrtSqlSessionFactory")
...
public class ElvLrtDataBaseConfig {
    ...
    public SqlSessionFactory elvlrtSqlSessionFactory(@Qualifier("elvlrtDataSource") DataSource elvlrtDataSource, ApplicationContext applicationContext) throws Exception{
        ...
        sqlSessionFactoryBean.setMapperLocations(applicationContext.getResources("classpath:com/actas/ems/mapper/elvlrt/*.xml"));
