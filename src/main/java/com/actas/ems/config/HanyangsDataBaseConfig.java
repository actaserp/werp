...
@Configuration
@MapperScan(value="com.actas.ems.mapper.hanyangs", sqlSessionFactoryRef="hanyangsSqlSessionFactory")
...
public class HanyangsDataBaseConfig {
    ...
    public SqlSessionFactory hanyangsSqlSessionFactory(@Qualifier("hanyangsDataSource") DataSource hanyangsDataSource, ApplicationContext applicationContext) throws Exception{
        ...
        sqlSessionFactoryBean.setMapperLocations(applicationContext.getResources("classpath:com/actas/ems/mapper/hanyangs/*.xml"));
