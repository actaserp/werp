...
public class App07ElvlrtService {
    ...
    @Autowired
    App07SamMapper app07ElvMapperS;
    @Autowired
    App07SjilsanMapper app07ElvMapperSj;
    int queryResult = 1;
    ...
    public Object GetMManulList(App07ElvlrtDto parm){
        ...
        switch (ls_dbnm){
            ...
            case "samjung":
                return  app07ElvMapperS.GetMManulList(parm);
            case "samjungilsan":
                return  app07ElvMapperSj.GetMManulList(parm);
            default:
                return null;
        }
    }
...
//    {return app07ElvMapper.GetMManulList(parm);}
    ...
    public App07ElvlrtDto GetMManuView(@RequestParam("fseq") String fSeq){
        ...
        switch (ls_dbnm){
            ...
            case "samjung":
                return  app07ElvMapperS.GetMManulView(fSeq);
            case "samjungilsan":
                return  app07ElvMapperSj.GetMManulView(fSeq);
            default:
                return null;
        }
    }
//    {return app07ElvMapper.GetMManulView(fSeq);}
    ...
    public boolean InsertMManu(App07ElvlrtDto parm){
        ...
        switch (ls_dbnm){
            ...
            case "hanyangs":
                ...
                return (queryResult > 0);
            case "samjung":
                queryResult = app07ElvMapperS.InsertMManul(parm);
                if(queryResult < 1){
                    queryResult = 0;
                }
                return (queryResult > 0);
            case "samjungilsan":
                queryResult = app07ElvMapperSj.InsertMManul(parm);
                if(queryResult < 1){
                    queryResult = 0;
                }
                return (queryResult > 0);
    ...
    public boolean UpdateMManu(App07ElvlrtDto parm){
        ...
        switch (ls_dbnm){
            ...
            case "hanyangs":
                ...
                return (queryResult > 0);
            case "samjung":
                queryResult = app07ElvMapperS.UpdateMManul(parm);
                if(queryResult < 1){
                    queryResult = 0;
                }
                return (queryResult > 0);
            case "samjungilsan":
                queryResult = app07ElvMapperSj.UpdateMManul(parm);
                if(queryResult < 1){
                    queryResult = 0;
                }
                return (queryResult > 0);
    ...
    public boolean DeleteMManu(App07ElvlrtDto parm){
        ...
        switch (ls_dbnm){
            ...
            case "hanyangs":
                ...
                return (queryResult > 0);
            case "samjung":
                queryResult = app07ElvMapperS.DeleteMManul(parm);
                if(queryResult < 1){
                    queryResult = 0;
                }
                return (queryResult > 0);
            case "samjungilsan":
                queryResult = app07ElvMapperSj.DeleteMManul(parm);
                if(queryResult < 1){
                    queryResult = 0;
                }
                return (queryResult > 0);
    ...
    public String getMManualMaxSeq(String parm){
        ...
        switch (ls_dbnm){
            ...
            case "samjung":
                return  app07ElvMapperS.getMManualMaxSeq(parm);
            case "samjungilsan":
                return  app07ElvMapperSj.getMManualMaxSeq(parm);
            default:
                return null;
        }
    }
//    {return app07ElvMapper.getMManualMaxSeq(parm);}
    ...
    public List<CommonDto> GetComm750List(){
        String ls_dbnm = UIUtils.getElvDataSourceNm();
            ...
            case "samjung":
                return  app07ElvMapperS.GetComm750List();
            case "samjungilsan":
                return  app07ElvMapperSj.GetComm750List();
            default:
